<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($error == false) {
            mysqli_query($connection, "INSERT INTO `channels`(`event_id`,`name`)
                VALUES('{$event['id']}','$name')");

            header('Location: ../events/detail.php?id='.$event['id'].'&channel_create=true#channels');
        }
    }
?>
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form class="needs-validation" method="POST" novalidate action="">
                ...
                <hr class="mb-4">
                <button class="btn btn-primary" name="submit" type="submit">Save channel</button>
